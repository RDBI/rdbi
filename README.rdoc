...
* RDBI::Statement yields RDBI::Result objects which leverage
  RDBI::Result::Driver classes to yield data.
* If you're interested in how schemas are types are dealt with, see
  RDBI::Schema, RDBI::Column, and RDBI::Type.

== Look ma, a code sample:
