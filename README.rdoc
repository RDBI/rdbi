= RDBI - Basic Database Access Re-imagined.
...
* RDBI is, at the time of this writing, less than a thousand lines of code.
...
* RDBI is architected around properties of a relational database, but there is
...
* Native client binding *and* interpolated binding for databases that do not
  support it.
* Don't like our driver? No one's requiring you to use it -- RDBI drivers
  aren't coupled with RDBI in any way.
* Result *drivers* can be used to transform your output to whatever you need --
...
* RDBI won't write your queries for you. (We have libraries that use RDBI for that)
* RDBI won't dictate your schema. It won't make you a rockstar and won't
  prevent you from being stupid or clever. It won't save you tons of time
  because you can't be bothered to think about how you access your data.
* Do not taunt RDBI.
